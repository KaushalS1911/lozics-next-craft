        ...
        <section className="relative bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-20 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">Final Inspection Reports</h1>
              <p className="text-xl text-gray-600">Comprehensive quality verification and documentation</p>
            </div>
          </div>
        </section>
